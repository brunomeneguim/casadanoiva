...
export default function CntImgSixthDress() {
    return (
        <div className={styles.cntSixthDress}>
            {
                SixthDress && SixthDress.map(SixthDress => {
                    return (
                        <figure className={`${styles.figSixthDress} ${styles.pushupSixthDress}`} key={SixthDress.id}>
                            <img className={styles.imgSixthDress} src={SixthDress.pathImg} alt={SixthDress.alt}
                            />
