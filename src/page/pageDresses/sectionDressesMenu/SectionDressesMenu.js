...
export default function SectionDressesMenu() {
  ...
  return (
    <section
      className={
        active
          ? `${styles.sectionDressesMenu} ${styles.sectionDressesMenuActive}`
          : `${styles.sectionDressesMenu}`
      }
      onClick={ToggleMode}
    >
      <div className={styles.window}>
        <div className={styles.cntMenu}>
          ...
          <div
            className={
              active ? `${styles.icon} ${styles.iconActive}` : `${styles.icon}`
            }
            onClick={ToggleMode}
          >
              ...
              MenuData.map((MenuData) => {
                return (
                  <ul className={styles.listItems} key={MenuData.id}>
                    <li>
                      <Link className={styles.linkDresses} to={MenuData.path}>
                        {MenuData.dressName}
                      </Link>
                    </li>
                  </ul>
