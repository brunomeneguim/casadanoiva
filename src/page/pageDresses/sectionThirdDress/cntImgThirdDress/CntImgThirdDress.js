...
export default function CntImgThirdDress() {
    return (
        <div className={styles.cntThirdDress}>
            {
                ThirdDress && ThirdDress.map(ThirdDress => {
                    return (
                        <figure className={`${styles.figThirdDress} ${styles.pushupThirdDress}`} key={ThirdDress.id}>
                            <img className={styles.imgThirdDress} src={ThirdDress.pathImg} alt={ThirdDress.alt}
                            />
